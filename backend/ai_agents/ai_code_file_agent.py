...
class AICodeFileAgent(AIAgent):
    ...
    @classmethod
    def _save_output_files(cls, files: tuple[Path, str], output_dir: Path = None) -> None:
    ...
    def run(self, prompt: str, input_files: list[Path] = None, input_dir: Path = None) -> str:
    ...
    def run_and_save_files(self, prompt: str, input_files: list[Path] = None, input_dir: Path = None, output_dir: Path = None) -> str:
